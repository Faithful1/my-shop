...
uploadFile = async e => {
    ...
    data.append('upload_preset', 'faya-shop');

    const res = await fetch('https://api.cloudinary.com/v1_1/fayatech/image/upload', {
        method: 'POST',
        body: data
    });
...
// for mutation it takes two args (mutationfunction, payload)
